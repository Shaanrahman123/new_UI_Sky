    ...
    return (
        <Popover className={`AvatarDropdown relative flex ${className}`}>
            {({ open, close }) => (
                <>
                    <Popover.Button
                        className={`self-center flex p-2 gap-3 h-10  sm:h-12 rounded-full text-slate-700  bg-slate-100 hover:bg-slate-200  focus:outline-none  items-center justify-center`}
                    >
                        <h4 className="font-semibold">Shaan Rahman</h4>
                    ...
                    >
                        <Popover.Panel className="absolute z-10 w-screen max-w-[260px] px-4 top-full -right-10 sm:right-0 sm:px-0">
                            <div className="overflow-hidden rounded-3xl shadow-lg  ring-opacity-5">
                                <div className="relative grid grid-cols-1 gap-6 bg-white py-7 px-6">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="flex-grow">
                                            <h4 className="font-semibold">Shaan Rahman</h4>
                                            <p className="text-xs mt-0.5">coderraufur@gmail.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <a
                                        href="#"
                                        className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100  focus:outline-none"
                                        onClick={() => close()}
                                    >
